...
class Curve0E66AE extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    Path path_0 = Path();
    path_0.moveTo(0, size.height * 0.4687500);
    path_0.lineTo(size.width * 0.02416667, size.height * 0.4166664);
    path_0.cubicTo(
    ...
    path_0.lineTo(size.width * 0.9758333, size.height * 1.562500);
    path_0.cubicTo(
        size.width * 0.9525000,
    ...
    path_0.lineTo(0, size.height * 0.4687500);
    path_0.close();

    Paint paint_0_fill = Paint()..style = PaintingStyle.fill;
    paint_0_fill.color = const Color(0xff0E66AE).withOpacity(1.0);
